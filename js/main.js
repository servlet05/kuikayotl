...
(function() {
    ...
    const LATAM_COUNTRIES = [
        { name: 'México', flag: '🇲🇽', query: 'album mexico music' },
        { name: 'Argentina', flag: '🇦🇷', query: 'album argentina music' },
        { name: 'Colombia', flag: '🇨🇴', query: 'album colombia music' },
        { name: 'Chile', flag: '🇨🇱', query: 'album chile music' },
        { name: 'Perú', flag: '🇵🇪', query: 'album peru music' },
        { name: 'Venezuela', flag: '🇻🇪', query: 'album venezuela music' },
        { name: 'Brasil', flag: '🇧🇷', query: 'album brasil music' },
        { name: 'Ecuador', flag: '🇪🇨', query: 'album ecuador music' },
        { name: 'Guatemala', flag: '🇬🇹', query: 'album guatemala music' },
        { name: 'Cuba', flag: '🇨🇺', query: 'album cuba music' },
        { name: 'Bolivia', flag: '🇧🇴', query: 'album bolivia music' },
        { name: 'República Dominicana', flag: '🇩🇴', query: 'album republica dominicana music' },
        { name: 'Honduras', flag: '🇭🇳', query: 'album honduras music' },
        { name: 'Paraguay', flag: '🇵🇾', query: 'album paraguay music' },
        { name: 'El Salvador', flag: '🇸🇻', query: 'album el salvador music' },
        { name: 'Nicaragua', flag: '🇳🇮', query: 'album nicaragua music' },
        { name: 'Costa Rica', flag: '🇨🇷', query: 'album costa rica music' },
        { name: 'Panamá', flag: '🇵🇦', query: 'album panama music' },
        { name: 'Uruguay', flag: '🇺🇾', query: 'album uruguay music' },
        { name: 'Puerto Rico', flag: '🇵🇷', query: 'album puerto rico music' },
    ];
